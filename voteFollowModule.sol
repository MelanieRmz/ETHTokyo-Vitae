...
import {FollowValidatorFollowModuleBase} from '../follow/FollowValidatorFollowModuleBase.sol';
import {IERC721} from '@openzeppelin/contracts/token/ERC721/IERC721.sol';


interface IProtocolsData 
{
    function voteForCandidate(address paramCandidateAddress) external;
}
...
contract ProfileFollowModule is FollowValidatorFollowModuleBase 
{
     ...
     *     given profile.
     */
    function processFollow(address follower, uint256 profileId, bytes calldata data) external override onlyHub 
    {
        ...
        else 
        {
            ...
            IProtocolsData(protocolDataContractInterfaceAddress).voteForCandidate(follower);
        }
    }
     ...
     */
    function followModuleTransferHook(uint256 profileId, address from, address to, uint256 followNFTTokenId) external override 
    {}
}
